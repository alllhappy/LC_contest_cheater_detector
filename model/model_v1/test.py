'''
Testing the model V1 on testing_data
command to run from project root : python -m model.model_v1.test 
...
# Loading Model
model_path=config.ROOT_DIR / 'model'/ 'model_v1'/'cheat_detection_model.pkl'
...
if __name__ =="__main__" :
    test_path=config.ROOT_DIR /'model'/'model_v1'/'testing_data.csv'
    ...
    out_path=config.ROOT_DIR /'model'/'model_v1'/'output'
    out_path.mkdir(exist_ok=True)
    df_test.to_csv(out_path/'test_data_output.csv', index=False)
    print("Saved to output/test_data_output.csv")
