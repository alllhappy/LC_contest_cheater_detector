...
# Load dataset
training_data_path=config.ROOT_DIR / 'dataset'/'training_data_final.csv'
testing_data_path=config.ROOT_DIR / 'dataset'/'testing_data_labelled.csv'
...
subtract_map = {
    1: 1774146600, #contest 494 startime
    2: 1774751400, #contest 495 startime
    3: 1775356200 #contest 496 startime
}
...
# Save dataset
output_path_training=config.ROOT_DIR / 'model' /'model_v1'/'training_data.csv'
output_path_testing=config.ROOT_DIR / 'model' /'model_v1'/'testing_data.csv'
features.to_csv(output_path_training, index=False)
